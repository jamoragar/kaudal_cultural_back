        ...
        `<tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                    <td valign="middle" width="85%" style="text-align:left; padding: 0 2em;">
                        <div class="product-entry">
                            ...
                            <div class="text">
                                <h3>TRIBUTO CIRCO Vol. 1</h3>
                                <span>Charly García</span>
                                <p>Espectáculo escénico que reúne la música en vivo de Piso 9 y el talento de lxs artistas circenses de Circo del Sur. Sábado 01 de Abril a las 20.00hrs. En O’Higgins #655 (Espacio de Artes Escénicas Circo del Sur)</p>
                            </div>
                        </div>
                    </td>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        <h2>Muchas gracias por confirmar su asistencia!</h2>
                                        <h3>Aquí encontrará los tickets que solicito para el evento</h3>
                                    </div>
                                </td>
                            </tr>
                        </table>
